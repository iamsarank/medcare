      ...
      <>
          ...
          <div className="container">
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">
                    ...
                    Vero amet, magnam in sed dolores est, ex error illo quae
                    dolorum neque aperiam rerum nam odit sunt, atque animi non
                    architecto?
                  </p>
              ...
              <div className="flex gap-[30px] justify-end">
                <div>
                  <img className="w-full" src={heroImg01} alt="heroImg02" />
                </div>
        ...
        <section>
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg-[55px] ">
            ...
            <div className="flex items-center justify-between flex-col lg:flex-row">
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                ...
                >
                  ...
                  <div
                    className="w-[65px] lg:w-[96px] bg-[#ccf0c3] py-1 px-2 lg:py-[6px] lg:px-[10px]
        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className="text__para text-center">
                World-class care for everyone. Our Health Syster offers
                unmatched, Expert health care.
              </p>
            </div>
            <DoctorList />
