    ...
    return (<div>
        ...
        <form>
            ...
            <div className="mb-5">
                ...
                <input type="text" name="name" value={formData.email} placeholder="Email"
            ...
            <div className="mb-5">
                ...
                <input type="text" name="bio" value={formData.bio} placeholder="Bio" onChange={handleInputChange}
                    maxLength={100} className="form__input" />
            </div>
                        ...
                        <div>
                            <div className="grid grid-cols-2 gap-5 md:grid-cols-4 mb-[30px]">
                                <div>
                                    ...
                                    <select className="form__input py-3.5" name="day" value={item.day} onChange={e => handleTimeSlotChange(e, index)}>
                                        <option value="">Select</option>
