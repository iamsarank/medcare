                ...
                {tab === 'overview' && <div>
                  <div className='flex items-center gap-4 mb-20'>
                    ...
                    <div>
                      ...
                      rounded-lg text-[12px] leading-4 lg:text-[16px] lg:leading-6 font-semibold '>
                        {data.specialization}
                      </span>
                      ...
                      <p className='text__para font-[14px] lg:max-w-[390px] leading-6'>{data?.bio}</p>
                    </div>
                  </div>
